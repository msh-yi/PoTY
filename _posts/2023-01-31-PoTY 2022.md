...
Nothing too surprising here, perhaps, given journal requirements for paper length etc. By wordcount, the longest paper is [*Potassium Trimethylsilanolate-Promoted, Anhydrous Suzuki–Miyaura Cross-Coupling Reaction Proceeds via the “Boronate Mechanism”: Evidence for the Alternative Fork in the Trail*](https://pubs.acs.org/doi/10.1021/jacs.1c08283){:target="_blank"} at 8993 words; the shortest paper is [*GeCl<sub>2</sub>·Dioxane–AgBF<sub>4</sub> Catalyzed Activation of Glycosyl Fluorides for Glycosylation*](https://www.nature.com/articles/s41557-022-00964-7){:target="_blank"} at 690 words.
